...
<xsl:variable name="actions">
  <xsl:if test="$numFound &gt; 0">
    <div id="buttons">
      ...
      <a class="action" href="export?{$exportParams}&amp;fl=id,subject,genre,host_genre,person_aut,person_edt,title,id_doi,id_scopus,id_pubmed,id_urn,id_duepublico,host_title,series,id_issn,id_isbn,shelfmark,year,volume,issue,pages,place,publisher&amp;wt=csv">CSV</a>
    </div>
  </xsl:if>
</xsl:variable>
