...
@Entity
@Table(name = "DEDUPLICATION_NO_DUPLICATE",
        indexes = {
...
@NamedQueries({
        @NamedQuery(name = DeduplicationNoDuplicate.DEDUPLICATION_KEY_DELETE_BY_MCR_ID, query = "DELETE FROM DeduplicationNoDuplicate d WHERE d.mcrId1 = :mcrId OR d.mcrId2 = :mcrId"),
})
public class DeduplicationNoDuplicate {
