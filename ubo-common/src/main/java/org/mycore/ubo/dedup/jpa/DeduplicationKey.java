...
@Table(name = "DEDUPLICATION_KEYS",
        indexes = {
                @Index(name = "DEDUPLICATION_KEYS_MCR_ID_IDX", columnList = "MCR_ID"),
                @Index(name = "DEDUPLICATION_KEYS_KEY_TYPE_IDX", columnList = "DEDUPLICATION_KEY, DEDUPLICATION_TYPE"),
                @Index(name = "DEDUPLICATION_KEYS_KEY_TYPE_MCR_ID_IDX", columnList = "DEDUPLICATION_KEY, DEDUPLICATION_TYPE, MCR_ID")
        }
)
@NamedQueries({
        @NamedQuery(name = DeduplicationKey.DEDUPLICATION_KEY_DELETE_BY_MCR_ID, query = "DELETE FROM DeduplicationKey d WHERE d.mcrId = :mcrId"),
})
