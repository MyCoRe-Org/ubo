...
<xsl:template name="numPublicationsUBO">
  ...
  <xsl:variable name="solr_query_confirmed" select="concat('q=status%3Aconfirmed+pub_nid_connection%3A',$connection_id)" />
  <xsl:variable name="solr_query_all" select="concat('q=pub_nid_connection%3A',$connection_id)" />
